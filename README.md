...
## Getting Started 
**1. Prerequisites**__
Before running the tool, ensure you have the following accounts and software ready:__
**Neo4j Database**__
You can use either the desktop version or the cloud-based sandbox:__
...
**AWS Access**__
The script requires read-only access to your AWS IAM infrastructure.__
